...
class Settings:
    def __init__(self, app):
        ...
        self.upd_settings_button = customtkinter.CTkButton(self.game_settings_group, text="Update game settings",
                                                           command=self.update_libs)
        self.upd_settings_button.grid(row=1, column=0, padx=(20, 20), pady=(10, 0), sticky="nsew")

        self.edit_settings_button = customtkinter.CTkButton(self.game_settings_group, text="Edit game settings",
                                                            command=self.edit_settings)
        self.edit_settings_button.grid(row=2, column=0, padx=(20, 20), pady=(10, 0), sticky="nsew")

        self.open_folder_button = customtkinter.CTkButton(self.game_settings_group, text="Open Folder",
